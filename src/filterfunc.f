...
c       print*,'  jmax=', jmax,' corran(jmax)= ',corran(jmax)-corran(1)
       ...
       time0=secnds(0.0)
       call  frac_diff(dcr,sig3,sig4,sngl(t_small),kmax,mmax)
...
c        covar(1,1)=covar(1,1)+const
        ...
        if (imak .eq. 1)  then
          ...
          do 2011i=1,jmax
            ...
            irow(i)=ix
2011      continue
         imax=int((corran(jmax)-corran(1))/t_small+0.5)+1
