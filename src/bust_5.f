...
65013  format(1x,i5,1x, f15.9, 1x, f16.3,1x,f8.2,1x,f8.2)
65023  format(1x,2i5,f15.9, 1x,f16.3, 1x,f8.2,1x,f8.2)
65033  format(1x,i4,i2.2,i2.2,f10.9, 1x,f16.3,1x,f8.2,1x,f8.2)
65043  format(1x,i4,'-',i2.2,'-',i2.2,'T',
     & i2.2,':',i2.2,':',i2.2,f2.1, 1x,f16.3,1x,f8.2,1x,f8.2)
65053  format(1x,f18.9, 1x,f16.3,1x,f8.2,1x,f8.2)
