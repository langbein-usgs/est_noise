...
c  Time is double precision!
      ...
      double precision t(11687),dtime(11687),
     & dtime_orig(11687),txx,tpress,dt_sam,ZBQLNOR,fjul,
     & t_orig(11687),
     & t_year(11687),t_year_orig(11687),timex,dts
      double precision rat_chg1(82),rat_chg2(82),rat_chng_norm(82),
     &  per(82),off(82),texp(82),aux_norm(82)
      double precision covar(11687,11687), covinv(11687,11687)
      double precision A(11687,82),A_orig(11687,82),
     & fmle,fv1,fv2,fv3,fv4,fmax
      double precision filtpl1(32768),filtpl2(32768),filtbp(32768),
     & covarpl1(11687,11687),covarpl2(11687,11687),
     & covarbp(11687,11687)
      dimension d(11687),d_orig(11687),x(82),e(82),res(11687)
c   ,enull(82)
      dimension bexp(82)
      integer irowmiss(11687)
...
310   format(f8.3,1x,a7,'    # PL-1 amplitude')
      ...
      read(5,*)exp1,choice(3)
      write(25,311)exp1,choice(3)
...
311   format(f8.3,1x,a7,'    # PL-1 index')
...
c
     ...
     & covinv(11687,11687),covar(11687,11687),chi2,sres(11)
     ...
     &  ai(max_mod,max_mod),wz(5000)
      ...
      double precision Finv(32768),Aw(max_data,max_mod),B(11687,11687),
...
c
      ...
      double precision ax(max_data,max_mod),dtime(11687),
     &  covinv(11687,11687),
     & covar(11687,11687),texp(82),t_start,t_stop,a1(max_mod,max_data),
     & a2(max_mod,max_mod),wzd(5000),evd(max_mod),t_year(11687),
     &  at,ai(82,82),ainv(82,11687),chi2,resA,Finv(32768)
      double precision Aw(max_data,max_mod),B(11687,11687),
...
c
c  H is filter
c  din and dout art input and output time serier
